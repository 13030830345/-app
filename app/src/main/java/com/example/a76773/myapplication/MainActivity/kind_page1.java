...
public class kind_page1 extends AppCompatActivity implements View.OnClickListener {
  Intent intent;
    //服务
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kind_page1);
        ...
        releaseservice = new Kindpageservice(kind_page1.this);
        //数据添加
//     releaseservice.init();

        releaselist=releaseservice.getAccountList(kind.getText().toString());

        commodityaAdapter = new CommodityaAdapter(kind_page1.this, 0,releaselist);
        ...
        releaselistew.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent = new Intent(kind_page1.this, Item_infoActivity.class);
