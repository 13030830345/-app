...
public class kind_page4 extends AppCompatActivity  implements View.OnClickListener {
    Intent intent;
    //服务
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        releaseservice = new Kindpageservice(kind_page4.this);
        //数据添加
//     releaseservice.init();

        releaselist=releaseservice.getAccountList(kind.getText().toString());

        commodityaAdapter = new CommodityaAdapter(kind_page4.this, 0,releaselist);
        ...
        releaselistew.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent = new Intent(kind_page4.this, Item_infoActivity.class);
